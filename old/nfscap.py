...
def process_img(original_img):
    ...
    processed_img=cv2.Canny(processed_img,100, 400)
...
def screen_record(): 
    ...
    while(True):
        printscreen =  np.array(ImageGrab.grab(bbox=(0,40,800,640)))      #(0,40,800,640)
        printscreen = process_img(printscreen)
        
        #cv2.imshow('newwin',new_screen)
        #cutimage(printscreen)
